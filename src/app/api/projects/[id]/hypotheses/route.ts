...
// DELETE /api/projects/[id]/hypotheses - Delete all hypotheses for a project
export async function DELETE(request: NextRequest, context: RouteContext) {
  try {
    ...
    // Delete all hypotheses for all runs in this project
    ...
    console.error('Failed to delete project hypotheses:', error);
    return NextResponse.json(
      { error: 'Failed to delete hypotheses' },
      { status: 500 }
    );
  }
}
